...
`, el);
  ...
  function rias_default(Alpine2) {
    ...
    Alpine2.directive("rias", (el, { expression }, { effect: effect2, evaluateLater: evaluateLater2 }) => {
      let evaluate2 = evaluateLater2(expression);
      effect2(() => {
        evaluate2((value) => {
  ...
  // build/plugins.js
  var plugins_default = plugins = [persistedStore_default, module_default2, rias_default];
  ...
  items.forEach((i) => module_default.plugin(i));
