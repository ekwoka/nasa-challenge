...
`, el);
  ...
  plugins_default.forEach((plugin2) => module_default.plugin(plugin2));
  data_default.forEach((data3) => module_default.plugin(data3));
  stores_default.forEach((store2) => module_default.plugin(store2));
